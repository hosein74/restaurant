                    ...
                    <tr>
                        ...
                        <td><?php
                            if ($value['request_type'] == 1)
                                ...
                                echo $submit;
                            ?></td>
                        <td ><button class="btn btn-warning pay" id="<?php  echo $value['request_id']?>" type="button" name="button">
                                <?php if ($value['request_type'] == 1)
                                     echo $pay;
                                else{
                                    echo $payed;
                                    ?>
    ...
    $(document).ready(function () {
        $(document).on('click','.pay', function(){
            ...
            $.ajax({
                ...
                data:{type:'payed',id:id},
                type:"GET",
                datatype:"json"
            }).done(function (json) {
                    obj.text("<?php echo $payed?>");
